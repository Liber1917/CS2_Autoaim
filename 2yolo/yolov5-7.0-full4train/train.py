...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    # hyp['lr0'] = hyp['lr0'] / 2  # 将学习率设置为原来的一半TODO
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'yolov5n.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/operators.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--batch-size', type=int, default=96, help='total batch size for all GPUs, -1 for autobatch')
